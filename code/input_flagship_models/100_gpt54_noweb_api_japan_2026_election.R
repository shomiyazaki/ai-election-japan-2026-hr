...
# GPT-5.4 (gpt-5.4-2026-03-05) - NO web search
...
# 3. API function -----------------------------------------------
get_response <- function(prompt, model = "gpt-5.4-2026-03-05", temperature = 1.0) {
  res <- NULL
  for (attempt in 1:3) {
    res <- tryCatch({
      POST(
...
outfile <- glue("data-out/flagship_models/japan2026_election_gpt54_noweb_wave_{wave_date}.csv")
