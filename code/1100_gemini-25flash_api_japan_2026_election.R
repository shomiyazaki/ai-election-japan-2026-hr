...
# 6. Save ------------------------------------------------------
if (!dir.exists("data-out/cross_model")) dir.create("data-out/cross_model", recursive = TRUE)
outfile <- glue("data-out/cross_model/japan2026_election_gemini-25flash_wave_{wave_date}.csv")
